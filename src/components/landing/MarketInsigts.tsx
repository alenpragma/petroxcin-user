...
import { landingImage } from "@/src/lib/store/image/image";
          ...
          <TabsContent value="all" className="mt-0">
            <div className="grid gap-8 sm:grid-cols-2 lg:grid-cols-3">
              ...
              >
                ...
                <CardContent>
                  <p className="text-gray-600">
                    Exploring how traditional energy companies are adapting to
                    the changing landscape while maintaining strong returns for
                    investors.
                  </p>
                </CardContent>
                <CardFooter>
              ...
              >
                ...
                <CardContent>
                  <p className="text-gray-600">
                    Analysis of how the global oil supply chain is adapting to
                    geopolitical challenges and what it means for investors.
                  </p>
                </CardContent>
                <CardFooter>
                  <Link
              ...
              >
                ...
                <CardContent>
                  <p className="text-gray-600">
                    ...
                    energy production and creating new investment opportunities.
                  </p>
                </CardContent>
                <CardFooter>
                  <Link
